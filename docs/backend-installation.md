...
`OdSensitivityResult` with normalized range/range-rate residuals and a JAX-derived residual Jacobian
with respect to the initial Cartesian state for differentiable OD research workflows.
