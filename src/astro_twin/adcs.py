...
def compute_adcs_timeline(
    ...
    actuator_utilization_fraction = config.required_slew_torque_n_m / config.max_torque_n_m
    return tuple(
        ADCSSample(
            ...
            slew_rate_margin_deg_s=config.max_slew_rate_deg_s - config.required_slew_rate_deg_s,
            actuator_utilization_fraction=actuator_utilization_fraction,
            actuator_utilization_margin_fraction=(
                config.maximum_actuator_utilization_fraction - actuator_utilization_fraction
            ),
        )
